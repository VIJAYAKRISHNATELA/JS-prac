...
//arrays isnide the arrays
const another_array=[1,233,4,[5,6,3,1,7,[9,5,3,2,1]]]
const real_another_array=another_array.flat(Infinity)
console.log(real_another_array)


console.log(Array.isArray("hish"))//false
console.log(Array.from("Krishna"))//willc cahange it to the array
